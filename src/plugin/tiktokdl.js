      ...
      if (selectedMedia) {
        try {
          ...
          if (type === 'video' && fileSizeInMB <= 300) {
            content = { video: finalMediaBuffer, mimetype: 'video/mp4', caption: ' 𝙿𝚘𝚠𝚎𝚛 𝙱𝚢 𝚁𝚌𝚍 𝙼𝚍 ⛧' };
          } else if (type === 'audio' && fileSizeInMB <= 300) {
            content = { audio: finalMediaBuffer, mimetype: 'audio/mpeg', caption: ' 𝙿𝚘𝚠𝚎𝚛 𝙱𝚢 𝚁𝚌𝚍 𝙼𝚍 };
          }
